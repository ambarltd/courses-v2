Feature: User - Request Primary Email Change Before First Verification
  As a registered user to the system, with an unverified email,
  I would like to request to change my primary email,
  So that I can use the system with the new email and verify it later.
  ...
  Background: Before verifying my primary email for the first time,
    ...
    And I am signed in, with an unverified email, using email "test@galeas.com" and password "Test12345*"
  ...
  Scenario: I can successfully request a primary email change twice
    ...
    Then my request should be successful
    And I should be able to sign in with email "test3@galeas.com" and password "Test12345*"
    And I should not be able to sign in with email "test@galeas.com" and password "Test12345*"
